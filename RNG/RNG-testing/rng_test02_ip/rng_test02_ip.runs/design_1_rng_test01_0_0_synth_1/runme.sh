...
HD_PWD='C:/RI/rng_test01_ip/rng_test01_ip.runs/design_1_rng_test01_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rng_test01_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rng_test01_0_0.tcl
