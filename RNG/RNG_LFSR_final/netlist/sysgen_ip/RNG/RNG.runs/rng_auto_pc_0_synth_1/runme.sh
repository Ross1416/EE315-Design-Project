...
HD_PWD='C:/RNG_LFSR_final/netlist/sysgen_ip/RNG/RNG.runs/rng_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rng_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rng_auto_pc_0.tcl
