...
HD_PWD='C:/RNG_LFSR_final/netlist/sysgen_ip/RNG/RNG.runs/rng_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rng_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rng_rst_ps7_0_100M_0.tcl
