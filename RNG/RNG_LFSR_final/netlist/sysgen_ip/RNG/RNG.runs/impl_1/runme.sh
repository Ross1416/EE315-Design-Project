...
HD_PWD='C:/RNG_LFSR_final/netlist/sysgen_ip/RNG/RNG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rng_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rng_wrapper.tcl -notrace
