...
HD_PWD='C:/RNG_LFSR_final/netlist/sysgen_ip/RNG/RNG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rng_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rng_wrapper.tcl
