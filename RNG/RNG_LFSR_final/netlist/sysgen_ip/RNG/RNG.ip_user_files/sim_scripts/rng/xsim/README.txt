...
#
# Generated by export_simulation on Wed Apr 26 16:04:44 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './rng.sh' script.
...
./rng.sh -noclean_files

For more information on the script, please type './rng.sh -help'.
